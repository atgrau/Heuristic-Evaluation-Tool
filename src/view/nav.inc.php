...
<nav id="top-nav" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0;">
    ...
    <ul class="nav navbar-top-links navbar-right navbar-collapse">
        <!-- /.dropdown -->
        <li class="padding-sm label label-<?php if ($GLOBALS["USER_SESSION"]->getRole() == 2) {echo "danger";} elseif($GLOBALS["USER_SESSION"]->getRole() == 1) {echo "info";} else {echo "primary";} ?>  margin-lg-r"><?= getRoleName($GLOBALS["USER_SESSION"]->getRole()); ?></li>
        <li class="dropdown">
